...
namespace Server.ClientNotifications
{
    ...
    {
        /// <summary>
        /// Sets a socket for use by the service. The socket has to be removed using <see cref="RemoveSocketAsync"/>
        ...
        /// <exception cref="ObjectDisposedException">When the synchronisation mechanisms have been disposed.</exception>
