...
Since one of the requirements is the prevention of the disruption of 'work' units, as if it the work is performed by a hardware resource, capable of handling a single request at a time - the 'work' endpoint is limited to a single request at a time.
